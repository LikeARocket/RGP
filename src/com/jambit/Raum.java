...
public class Raum {
    ...
    public void gruss() {
        System.out.println("Willkomen zu jambit");                  //Folgende 3 Lines beinhalten nur begrüßungs text
        System.out.println("Ihr Ziel ist es, Cherry zu finden.");
        System.out.println("");
        System.out.println("                                                   _________________________________________________________________\n" +   //Who would have thaught, this is a map
                "                                                   |                                                                |\n" +
                "                                                   |                                                                |\n" +
                "                                                   |                                                                |\n" +
                ...
                "|                                                                       |                                           |\n" +
                "|                                                                                                                   |\n" +
                "|________________________________________________   _________   ________|___________________________________________|\n" +
                "|                                                       |                                                           |\n" +
                "|                                                       |                                                           |\n" +
                "|                                                       |                                                           |\n" +
                "|                      Lombok (l)                       |                        Sumatra (s)                        |\n" +
    ...
    public boolean checkCherry() {      //verschiedene Win-loos nachrichten
    ...
    public int quickmaths() {
        int abc = (int) (Math.random() * 2);     //Random 50-50 Chancen, das Cherry da ist.
        return abc;
    }
    ...
    public void raumAuswahl() {
        ...
        while (true) {
            ...
            String auswahl;
            switch (welcome) {                 //Ist für die Raumauswaht zuständig
                case "Sumatra":
                case "s":
                    auswahl = "Sumatra";
                    clear();
                ...
                case "i":
                    ...
                    if (what == 1) {
                        ...
                        System.out.println("Alma: ja, Cherry müsste hier irgendwo im 3ten Stock sein");
                        raumAuswahl();
                    } else if (what == 2) {
                        clear();
                ...
                case "th":
                    auswahl = "Treppenhaus";
                    clear();
                    System.out.println("Adi-Rudi Schmitt: RAUS HIER! Ich bin gerade am rauchen!");
                    raumAuswahl();
                    break;
                case "DamenToilette":
                case "dt":
